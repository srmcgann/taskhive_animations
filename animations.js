init=()=>{
	...
	v[0].c.style.height=(document.getElementsByClassName("img4")[0].clientHeight/3)+"px";
	...
	v[1].c.height = v[1].c.clientHeight;
	v[1].vx=document.getElementsByClassName("img2")[0].clientWidth/951.5;
	v[1].vy=document.getElementsByClassName("img2")[0].clientHeight/567;
	v[1].c.style.height=document.getElementsByClassName("img2")[0].clientHeight+"px";
	startStopAnimations();
}
...
isScrolledIntoView=(elem)=>{
    ...
    return ((docViewTop-elem.clientHeight < elemTop) && (docViewBottom+elem.clientHeight > elemBottom));
}
...
drawMapAnimation=(v)=>{
	...
	for(var i=0;i<v[1].p.length;++i){
		x.beginPath();
		x.arc(v[1].p[i].x*v[1].vx,v[1].p[i].y*v[1].vy,3.5*v[1].vx,0,Math.PI*2);
		x.globalAlpha=.9;
		x.fillStyle="#fff";
		x.fill();
		x.beginPath();
		x.arc(v[1].p[i].x*v[1].vx,v[1].p[i].y*v[1].vy,1.5*v[1].vx,0,Math.PI*2);
		x.globalAlpha=1;
		x.fillStyle="#00f";
		x.fill();
	}
